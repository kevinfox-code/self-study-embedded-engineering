...
| RM0456 — STM32U5 Series Reference Manual | `ESE-311/books/rm0456-stm32u5-series-armbased-32bit-mcus-stmicroelectronics.pdf` | Peripheral register reference for U575 |
| STM32U575AG Datasheet | `ESE-311/books/stm32u575ag.pdf` | Electrical specs and pin assignments |
| UM2861 — NUCLEO-U575ZI Board Manual | `ESE-311/books/um2861-stm32u5-nucleo144-board-mb1549-stmicroelectronics.pdf` | Board schematic and jumper settings |
| Arm Cortex-M33 Generic User Guide | `ESE-311/books/arm_cortex_m33_dgug_100235_06_en.pdf` | Core architecture: SysTick, NVIC, MPU, FPU |
