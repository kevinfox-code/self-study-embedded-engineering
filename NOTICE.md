...
Portions of the repository — documentation, and in some weeks source code — were
...
## Third-Party Material and Licensing Boundaries

Original repository content is licensed under MIT — see [LICENSE](LICENSE).

This repository does **not** redistribute vendor documentation. Reference
...
license files are kept alongside the code they cover.

References to third-party books, vendor hardware, trademarks, or standards are
included for educational context only and are not relicensed by this repository.
