...
This project is licensed under MIT (see LICENSE) for original repository content.

References to third-party books, vendor hardware, course materials, trademarks, or standards are included for educational context only and are not relicensed by this repository.

Do not commit copyrighted third-party materials unless you have explicit rights to distribute them.
